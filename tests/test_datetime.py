...
from app.persistence import _idle_timeout_exceeded, _parse_snapshot_timestamp, configure_persistence
...
def test_idle_timeout_exceeded_is_stable_for_mixed_snapshot_formats() -> None:
    ...
    assert _idle_timeout_exceeded(previous={"idle_since": "2026-04-11T12:00:00+00:00"}, now=now) is True
...
def test_idle_timeout_exceeded_falls_back_to_state_changed_at() -> None:
    ...
    assert _idle_timeout_exceeded(previous={"state_changed_at": "2026-04-11T12:00:00Z"}, now=now) is True
