...
def test_default_sorting_respects_status_order_and_unknown_alphabetical_only():
    items = [
        ...
        _device(
            "AA:03",
            status="offline",
            offline_since="2026-04-10T09:00:00+00:00",
            online_since=None,
        ),
        _device(
            "AA:04",
            status="idle",
            idle_since="2026-04-10T10:30:00+00:00",
            online_since="2026-04-10T09:00:00+00:00",
        ),
        _device(
            "AA:05",
            status="unknown",
            hostname="alpha",
            state_changed_at="2026-04-11T00:00:00+00:00",
        ),
    ]

    sorted_items = sort_items(items)
    assert [row["status"] for row in sorted_items] == [
        "online",
        "idle",
        "offline",
        "unknown",
...
def test_explicit_single_column_sorting_and_direction_cycle():
    items = [
        _device(
            ...
            ip="192.168.88.25",
            status="idle",
            idle_since="2026-04-10T10:10:00+00:00",
        ),
        _device(
            "AA:02",
            hostname="alpha",
            ip="192.168.88.2",
            status="online",
            online_since="2026-04-10T10:20:00+00:00",
        ),
        _device(
            "AA:03",
            hostname="gamma",
            ip="192.168.88.15",
            status="offline",
            offline_since="2026-04-10T10:05:00+00:00",
            online_since=None,
        ),
    ]
...
def test_mode_end_vs_all_and_summary_scope():
    ...
    complete = _device(
        ...
        idle_since="2026-04-10T10:11:00+00:00",
    )
    ...
    regular = _device(
        "AA:14",
        status="offline",
        offline_since="2026-04-10T10:12:00+00:00",
        online_since=None,
    )
...
def test_filters_only_affect_rows_and_clear_restores_rows():
    items = [
        ...
        _device(
            "AA:22",
            status="offline",
            offline_since="2026-04-10T10:34:00+00:00",
            online_since=None,
        ),
    ]
...
def test_unknown_visibility_and_sorting_without_time_fallback():
    items = [
        _device(
            ...
            status="unknown",
            hostname="charlie",
            state_changed_at="2026-04-11T12:00:00+00:00",
        ),
        _device(
            "AA:31",
            status="unknown",
            hostname="bravo",
            state_changed_at="2026-04-09T12:00:00+00:00",
        ),
...
def test_empty_and_null_values_are_handled_deterministically():
    items = [
        _device(
            ...
            status="online",
            online_since=None,
            state_changed_at="2026-04-10T10:01:00+00:00",
        ),
        _device(
            "AA:41",
            hostname="alpha",
            ...
            status="online",
            online_since=None,
            state_changed_at="2026-04-10T10:02:00+00:00",
        ),
        _device(
            "AA:42",
            hostname="bravo",
            ...
            status="idle",
            idle_since=None,
            state_changed_at="2026-04-10T10:03:00+00:00",
        ),
    ]
